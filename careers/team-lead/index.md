...
<div class="w-full lg:w-1/2"><a class="inline-block md:w-auto lg:mt-0 mt-10 mb-2 md:mb-0 px-8 py-4 mr-4 text-lg float-right font-medium leading-normal bg-green-500 text-white rounded transition duration-200" href="https://www.indeed.com/job/team-lead-cloud-sys-admin-e8a4f40d44c6daa2" target="_blank">Apply Now</a></div>
</div>
<div class="container px-4 mx-auto">
